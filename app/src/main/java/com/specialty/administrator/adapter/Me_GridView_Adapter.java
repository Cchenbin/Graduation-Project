...
public class Me_GridView_Adapter extends BaseAdapter{
    private Context context;
    private List<Picture> pictures = new ArrayList<>();
    private LayoutInflater inflater;

    public Me_GridView_Adapter(String[] titles, Integer[] images, Context context) {
        super();
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.image = view.findViewById(R.id.my_image);
            holder.title = view.findViewById(R.id.my_title);
            view.setTag(holder);
        } else {
